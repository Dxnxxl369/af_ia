...
class AppTheme {
  ...
  static ThemeData _buildTheme({
    ...
    return base.copyWith(
      ...
      highlightColor: tertiaryColor.withOpacity(0.5), // Color al presionar
      splashColor: accentColor.withOpacity(0.1), // Efecto splash
      ...
      colorScheme: base.colorScheme.copyWith(
         ...
         onBackground: textPrimaryColor, // Texto sobre 'background'
